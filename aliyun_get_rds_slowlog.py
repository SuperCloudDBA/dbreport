...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='''阿里云RDS实例每日慢查询报告小工具
Example：
获取所有地域RDS实例的每日慢查询报告
    python3 aliyun_get_rds_slowlog.py --AccessKeyId ACCESSKEYID --AccessKeySecret ACCESSKEYSECRET --OutDir ./
